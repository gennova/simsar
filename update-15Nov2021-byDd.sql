...
MySQL - 10.1.33-MariaDB : Database - simsar
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`simsar` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
(2,2,'admin','Admin','User','admin@gmail.com','544354353','','$2y$10$ejewXkbluc6ysl7TUSbhgO9dkMBEjH7eIxXVNIfjsen2eGbbURPrS','2021-11-15 09:26:13',1,1,1,0,'','','202.138.242.23','2018-03-19 00:00:00','2021-11-15 09:26:13','P01'),
(6,1,'antoniusdede','Antonius Dede','Bandung','antoniusdede@gmail.com','0123456789','','$2y$10$eM9jXrr.1FWAHEvJMrvl1ufAYxBwsc2DNRc/FPp0hmKLdDN6sZpT2','2021-11-15 08:05:51',1,1,1,0,'','','202.138.242.23','2019-11-21 00:00:00','2021-11-15 08:05:51','P01'),
...
(11,2,'adminsmg','Admin YPII','Semarang','admin@gmail.com','544354353','','$2y$10$ejewXkbluc6ysl7TUSbhgO9dkMBEjH7eIxXVNIfjsen2eGbbURPrS','2021-11-15 07:01:09',1,1,1,0,'','','202.138.242.23','2021-11-12 16:11:36','2021-11-15 07:01:09','P01'),
...
(13,2,'tksinarmatahari','TK Sinar Matahari','Semarang','sarprasypii@gmail.com','12345678','','$2y$10$c1I/Q773Yqfp5pMIuMDuNeFi3I32h1E7CP6dMPgeP1T7JB2szeWUa','2021-11-15 09:50:49',1,1,1,0,'','','202.138.242.23','2021-11-12 00:00:00','2021-11-15 09:50:49','S02'),
...
(4,'A','KRS',8,'R-00003','A-KRS-P01-','YYS','0000000004','A-KRS-P01-YYS-0000000004-2013','Kursi Chitose Teknisi',150000,NULL,NULL,'2013-04-09',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'P01'),
(5,'A','KRS',8,'R-00002','A-KRS-S02-','YYS','0000000005','A-KRS-S02-YYS-0000000005-2009','Kursi Guru 01',NULL,NULL,NULL,'2009-01-01',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S02');
...
insert  into `tblpengajuan`(`idpengajuan`,`nopengajuan`,`tglpengajuan`,`norab`,`namabarang`,`satuan`,`jmlbarang`,`hargasatuan`,`jmlharga`,`keterangan`,`unit`) values 
(1,'PB-P01-0000000001','2021-11-15','-','Mouse Kabel Logitech','unit',2,50000,100000,NULL,'P01'),
(2,'PB-S02-0000000002','2021-11-14','RAB/123/TK/001','Infokus','unit',1,4500000,4500000,'<p>\n	Untuk di kelas TK</p>\n','S02');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vbarangpinjam` AS (select `tblpeminjaman`.`nopinjam` AS `nopinjam`,`tblpeminjaman`.`tglpinjam` AS `tglpinjam`,`tblpeminjaman`.`kdbarang` AS `kdbarang`,`tblpeminjaman`.`nmpeminjam` AS `nmpeminjam`,`tblpeminjaman`.`unitpeminjam` AS `unitpeminjam`,`tblpeminjaman`.`acara` AS `acara`,`tblpeminjaman`.`tglkembali` AS `tglkembali`,`tblpeminjaman`.`keterangan` AS `keterangan`,`tblpeminjaman`.`unit` AS `unit` from `tblpeminjaman` where isnull(`tblpeminjaman`.`tglkembali`)) */;
