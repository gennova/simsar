...
class Admin_model extends CI_Model{
	...
	public function get_user_detail(){
		...
		log_message('INFO', '------------------------------------ '.$this->router->fetch_class().'||'.$this->router->fetch_method().' - '.$id." Get User Detail");
	...
	public function update_user($data){
		$id = $this->session->userdata('admin_id');
		log_message('INFO', '------------------------------------ '.$this->router->fetch_class().'||'.$this->router->fetch_method().' - '.$id." Update User");
