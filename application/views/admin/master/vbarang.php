 ...
 <section class="content">
	<div class="row">
		<div class="col-md-12">
			<div class="box box-body">
				<div class="col-md-6">
					<h4><i class="fa fa-list"></i> &nbsp; Data Barang</h4>
				</div>  
				
				<div class="col-md-6 text-right">
					<button class="form-control btn btn-success" data-toggle="modal" data-target="#import-barang"><i class="fa fa-list"></i> Import Data</button>
				</div>
   ...
   <div class="box">
    ...
    <div class="box-body table-responsive">
		...
		<?php
			$data['judul'] = 'barang';
			$data['url'] = 'admin/barang/import';
			echo show_my_modal('modals/modal_import', 'import-barang', $data);
		?>
