	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-body">
				<div class="col-md-6">
					<h4><i class="fa fa-list"></i> &nbsp; Data Pengajuan Barang</h4>
				</div>
				
				<div class="col-md-6 text-right">
					<a href="<?= base_url('admin/vtglpengajuan'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Cetak Pengajuan per tanggal</a>
				</div>
